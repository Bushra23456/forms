                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" value="<?php echo $rows['categoryName'] ?>" name="categoryname" class="form-control" placeholder="enter your name">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>categoryImage</label>
                                                <h5 class="text-dark"><?php echo $rows['categoryImage'] ?></h5>
